class ParticipantesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @participante.save
        format.html { redirect_to @participante, notice: 'Participante Cadastrado. successfully!' }
  ...
  def update
    respond_to do |format|
      if @participante.update(participante_params)
        format.html { redirect_to @participante, notice: 'Participante Alterado. successfully!' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to participantes_url, notice: 'Participante Deletado. successfully!' }
  ...
  private
    ...
    def participante_params
      params.require(:participante).permit(:nome, :tipo, :matricula, :email, :telefone)
    end
end
